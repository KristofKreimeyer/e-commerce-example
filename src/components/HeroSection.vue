  ...
  <section class="relative bg-white overflow-hidden">
    ...
    <div class="relative max-w-6xl mx-auto px-6 py-24">
      <div class="text-center max-w-4xl mx-auto">
        <h1 class="text-6xl md:text-8xl font-light apple-text tracking-tight">Premium</h1>
        <h2 class="text-4xl md:text-6xl font-light gradient-text tracking-tight mb-6 leading-[1.5]">
          Shopping Experience
        </h2>
        <p class="text-xl apple-secondary mb-12 max-w-2xl mx-auto leading-relaxed">
          Entdecke außergewöhnliche Produkte mit der Qualität und dem Design, die du verdienst.
        </p>
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
          <router-link to="/catalog" class="apple-text">
            <ButtonComponent
              type="button"
              size="lg"
              variant="primary"
